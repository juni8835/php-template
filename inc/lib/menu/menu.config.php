...
$STATIC_ROOT = empty($PROJECT_DIR) ? $SERVER_ROOT : $SERVER_ROOT.'/'.$PROJECT_DIR;
$CLIENT_ROOT = $PROJECT_DIR;
$HTML_LANG  = $DEFAULT_LANG;

// 보드 정보 ==============================================
$BOARD_DIR      = $PROJECT_DIR.'/pages/board';
...
if($BOARD_LANG){
  ...
  $CLIENT_ROOT  = $PROJECT_DIR."/lang/{$HTML_LANG}";
}
